...
import ControlProductos from '../screens/ControlProductos';
import ControlInventario from '../screens/ControlInventario';
    ...
    case 'admin':
      return (
        <Tab.Navigator>
          ...
          <Tab.Screen name="Productos" component={ControlProductos} options={commonOptions('pricetag-outline')} />
          <Tab.Screen name="Inventario" component={ControlInventario} options={commonOptions('layers-outline')} />
          <Tab.Screen name="Perfil" component={PerfilScreen} options={commonOptions('person-outline')} />
        </Tab.Navigator>
      );
